...
public class DrawingFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ChooseShape.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Line", "Circle", "Rectangle", "Square" }));
    ...
    private void LineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LineActionPerformed
        ...
        System.out.println(drawingPanel1.getShapes()[0].getPosition().y);
        drawingPanel1.refresh(null);
        
        //LineSegment line = new LineSegment(new Point(0, 0), new Point(100, 100), Color.red, Color.yellow);
        //line.draw(g);
        
    }//GEN-LAST:event_LineActionPerformed

    private void CircleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CircleActionPerformed
        //Circle c = new Circle(new Point(20, 20), 10, Color.red, Color.blue);
        //c.draw(g);
