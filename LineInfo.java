...
public class LineInfo extends javax.swing.JFrame {
    ...
    public LineInfo(LineSegment line) 
    {
        initComponents();
        this.line = line;
    }
    ...
    private void initComponents() {
        ...
        xStartingTextField.setText("100");
        ...
        yStartingTextField.setText("50");

        xEndingTextField.setText("400");

        yEndingTextField.setText("50");
    ...
    private void borderColorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borderColorButtonActionPerformed
        ...
        borderColor = jColorChooser1.showDialog(null, "Select a border color", col);
    ...
    private void createLineButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createLineButtonActionPerformed
        ...
        line.setPosition(new Point(startingX,startingY));
        line.setEndPosition(new Point(endingX,endingY));
        ...
        df.setVisible(true);
            ...
            JOptionPane.showMessageDialog(null, "Enter numeric inputs");
        }
