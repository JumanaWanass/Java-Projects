...
public class LibrarianRole {
    ...
    private Database sBDatabase ;
     ...
     {
        this.sBDatabase = new StudentBookDatabase(Constants.FileNames.STUDENTSBOOKS_FILENAME);
        this.bookDatabase = new BookDatabase(Constants.FileNames.BOOKS_FILENAME);
        this.sBDatabase.readFromFile();
        this.bookDatabase.readFromFile();
     }

     public void addBook(String id, String title, String authorName,
